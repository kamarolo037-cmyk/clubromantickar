...
// BUG FIX: принимаем hasNextScene чтобы не показывать "▼ продолжить"
// когда у сцены нет ни choices ни next_scene (конец игры/тупик)
export default function DialogueBox({ speaker, text, displayedText, isTyping, hasNextScene, onSkip }) {
  ...
  return (
    ...
    >
      ...
      {/* Подсказка "тап чтобы продолжить" — только если есть куда идти */}
