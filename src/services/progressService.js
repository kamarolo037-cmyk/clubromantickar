 ...
 * BUG FIX: параметр переименован в current_scene (snake_case) чтобы совпадать
 * с тем что передаётся из handleChoice в GamePage.
 */
export async function saveProgress(telegramId, { current_scene, chapter, relationships, flags }) {
